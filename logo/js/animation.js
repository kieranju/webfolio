$(document).ready(function() {
    ...
    function startSVGAnimation(fromElement, toElement) {
        fromElement.css('display', 'inline');
        drawSVGPaths(fromElement, 400, 400, 100);
        
        fromElement.delay(800).fadeTo(1000, 0);
        toElement.delay(200).fadeTo(1500, 1);
    }

    var logoImage = $('#logo-img');
    
    replaceWithPaths($('svg'));
    startSVGAnimation($('svg'), $(logoImage));
});